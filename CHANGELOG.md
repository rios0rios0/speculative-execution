...
- refreshed `CLAUDE.md`, `.github/copilot-instructions.md`, and `.github/skills/code-review/SKILL.md` to document the new `checks` pull-request gate and to reword the Slack prefix in the secret-hygiene rule so it no longer matches the SAST scanner
